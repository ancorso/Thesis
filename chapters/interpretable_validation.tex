...
\begin{figure}
    \centering
    \input{figures/interpretable_validation/twocar_failure_examples}
...
\begin{figure}
    \input{figures/interpretable_validation/stl_pedestrian_failure_examples}
...
\begin{figure}
    \centering
    \input{figures/interpretable_validation/stl_pedestrian_sensitivity}
...
\begin{figure}
    \input{figures/interpretable_validation/state_dep_failure_examples}
...
\begin{figure}
    \centering
    \input{figures/interpretable_validation/state_dep_result_sensitivity}
